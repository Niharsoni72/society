...
if (strlen($_SESSION['smsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        // Check if flat is already allotted in the block
        ...
        if ($query1->rowCount() > 0) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblallotment (Name, ContactNumber, Password, Block, FlatNum, EContactnum, Noofmember, Address) VALUES (:name, :contnum, :password, :block, :flatnum, :econtnum, :memfamily, :address)";
                ...
                if ($query->rowCount() > 0) {
                    ...
                    echo '<script>alert("Failed to add allotment detail. Please try again.")</script>';
                }
                                ...
                                <form id="basic-form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" name="flatnum" id="flatnum" value="" class="form-control" required="true">
                                            <option value="1">Choose Flat Number</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
