...
if (isset($_POST['delete_notice'])) {
    ...
    $sql = "DELETE FROM notice WHERE noticeId = :notice_id";
    $query = $dbh->prepare($sql);
    $query->bindParam(':notice_id', $notice_id, PDO::PARAM_INT);
    $query->execute();
    // Redirect back to the same page after deleting notice
                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2 class="notice-heading">Manage Notice</h2> <!-- Add class "notice-heading" to the h2 element -->
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <form method="post" action="">
                                    <input type="hidden" name="notice_id" value="<?php echo $row->noticeId; ?>">
                                    <button type="submit" name="delete_notice" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this notice?')">Delete</button>
                                </form>
                            </div>
                        </div>
                    </div>
