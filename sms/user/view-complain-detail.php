                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT * FROM tblallotment WHERE Block = :block AND FlatNum = :flatnum AND ID = :uid";
                                            ...
                                            ?>
                                                    <table border="1" class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row1->Echarge; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Maintenance Charge</th>
                                                            <td><?php echo $row1->Mcharge; ?></td>
                                                        </tr>
                                                        <tr>

                                                            <th>Total Charge</th>
                                                            <td><?php echo $row1->Mcharge + $row1->Echarge; ?></td>
                                                        </tr>
                                                    </table>
                                        <?php
                                                }
                                    ...
                                    ?>
                                        <p>No allotment details found.</p>
                                    <?php
                                    }
                                    ?>
